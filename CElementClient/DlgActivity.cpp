...
AUI_ON_COMMAND("Btn_PracaMagica", OnCommand_MainType)
...
bool CDlgActivity::OnInitDialog()
{
	...
	DDX_Control("Btn_PracaMagica", m_pBtn_PracaMagica);
...
{
	OnCommand_MainType("Btn_PracaMagica");
}
...
void CDlgActivity::OnCommand_MainType(const char* szCommand)
{
	...
	{ m_pBtn_Daily, m_pBtn_Instance, m_pBtn_Holiday, m_pBtn_PracaMagica };
