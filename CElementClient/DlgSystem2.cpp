...
AUI_ON_COMMAND("wfactionsearch",		OnCommandFactionSearch)
...
void CDlgSystem2::OnCommandFactionSearch(const char* szCommand)
{
	CDlgGuildSearch *pDlg = GetGameUIMan()->m_pDlgGuildSearch;
	pDlg->Show(!pDlg->IsShow());
}
