...
{\
	...
	case RANK_INFO:				dwSize = sizeof(cmd_rank_info); break;
	case ASTROLABE_INFO_NOTIFY: dwSize = sizeof(astrolabe_info_notify); break;
	default:
		break;
	}
...
/*
	...
	*/
	...
	case PRAY_DISTANCE_CHANGE:
		...
		break;
	case RANK_INFO:
		pGameRun->PostMessage(MSG_PM_RANKINFO, MAN_PLAYER, -1, (DWORD)pDataBuf, pCmdHeader->cmd);
		break;
	case ASTROLABE_INFO_NOTIFY:
		pGameRun->PostMessage(MSG_HST_ASTROLABE_INFO_NOTIFY, MAN_PLAYER, 0, (DWORD)pDataBuf, pCmdHeader->cmd);
		break;
	default:
		break;
	}
