...
#ifdef ANGELICA_2_2
	g_pGame->GetA3DDevice()->GetD3DDevice()->StretchRect(g_pGame->GetA3DDevice()->GetBackBuffer()->m_pD3DSurface, NULL, m_pBackTarget->GetTargetSurface()->m_pD3DSurface, NULL, D3DTEXF_POINT);
#else
