...
{
	INIT_DIALOG_POINTER(m_pDlgLibProduceRelationshipAwardSub, CDlgLibProduceRelationshipAwardSub, "Win_ProduceRelationshipAward_Sub");
	INIT_DIALOG_POINTER(m_pDlgLibProduceRelationshipAwardSubList, CDlgLibProduceRelationshipAwardSubList, "Win_ProduceRelationshipAward_Sublist");
	...
	INIT_DIALOG_POINTER(m_pDlgGuildSearch, CDlgGuildSearch, "Win_GuildSearch"); // Alien - adicionado
	INIT_DIALOG_POINTER(m_pDlgGuildPlayerSearch, CDlgGuildPlayerSearch, "Win_GuildSearchPlayer"); // Alien - adicionado
	...
	INIT_DIALOG_POINTER(m_pDlgFortunePallete, CDlgFortunePallete, "Win_ContinousMain");
	INIT_DIALOG_POINTER(m_pDlgNewTransportation, CDlgNewTransportation, "Win_NewTransportation");
	INIT_DIALOG_POINTER(m_pDlgLibProduce, CDlgLibProduce, "Win_ProduceLibrary");
	INIT_DIALOG_POINTER(m_pDlgLibProduceRelationship, CDlgLibProduceRelationship, "Win_ProduceRelationship");
}
...
#define MAP_FILE_TO_CREATOR(file, dialogclass) s_mDialogCreator[file] = &wmgj_new_##dialogclass;  s_mDialogCreator["version01\\"##file] = &wmgj_new_##dialogclass;
	...
	DEFINE_DIALOG_CREATOR(CDlgGuildSearch)
	DEFINE_DIALOG_CREATOR(CDlgGuildPlayerSearch)
#ifdef RESOURCE_BATTLE
	...
	DEFINE_DIALOG_CREATOR(CDlgFortunePallete)
	DEFINE_DIALOG_CREATOR(CDlgNewTransportation)
	DEFINE_DIALOG_CREATOR(CDlgLibProduce)
	DEFINE_DIALOG_CREATOR(CDlgLibProduceRelationship)
	DEFINE_DIALOG_CREATOR(CDlgLibProduceRelationshipCostSub)
	DEFINE_DIALOG_CREATOR(CDlgLibProduceRelationshipCostSubList)
	DEFINE_DIALOG_CREATOR(CDlgLibProduceRelationshipAwardSub);
	DEFINE_DIALOG_CREATOR(CDlgLibProduceRelationshipAwardSubList);
	...
	static DialogCreatorFunc FindDialogCreator(const AString &strFileName)
	{
		...
		if (!s_init)
		{
			...
			MAP_FILE_TO_CREATOR("guild_search.xml", CDlgGuildSearch) // Alien - adicionado
			MAP_FILE_TO_CREATOR("guildsearchplayer.xml", CDlgGuildPlayerSearch) // Alien - adicionado
#ifdef RESOURCE_BATTLE
			...
			MAP_FILE_TO_CREATOR("continuousmain.xml", CDlgFortunePallete)

			MAP_FILE_TO_CREATOR("newtransportation_2021.xml", CDlgNewTransportation)
			MAP_FILE_TO_CREATOR("produce_library.xml", CDlgLibProduce)
			MAP_FILE_TO_CREATOR("produce_relationship.xml", CDlgLibProduceRelationship)
			MAP_FILE_TO_CREATOR("produce_relationshipaward_sub.xml", CDlgLibProduceRelationshipAwardSub)
			MAP_FILE_TO_CREATOR("produce_relationshipaward_sublist.xml", CDlgLibProduceRelationshipAwardSubList)			
			MAP_FILE_TO_CREATOR("produce_relationshipcost_sublist.xml", CDlgLibProduceRelationshipCostSubList)
			MAP_FILE_TO_CREATOR("produce_relationshipcost_sub.xml", CDlgLibProduceRelationshipCostSub)
