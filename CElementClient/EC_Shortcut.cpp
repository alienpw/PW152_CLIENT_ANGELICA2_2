...
bool CECSCCommand::Execute()
{
	...
	case CMD_PICKUP_ALL:		pHost->CmdPickupALL();								break;
...
const char* CECSCCommand::GetIconFile()
{
	...
	case CMD_PICKUP_ALL:		szIconFile = res_IconFile(RES_ICON_CMD_PICKUP_ALL);			break;
...
const wchar_t* CECSCCommand::GetDesc()
{
	...
	case CMD_PICKUP_ALL:		szDesc = pDescTab->GetWideString(CMDDESC_PICKUP_ALL);		break;
